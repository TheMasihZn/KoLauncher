...
return {
    name = "CheetSheet",             -- Internal plugin identifier used in code (e.g., "dictionary", "clock", "wifi")
    fullname = _("CheetSheet"),      -- Display name shown in UI (translatable) (e.g., "Dictionary", "Clock Widget", "WiFi Manager")
    description = _([[CheetSheet]]), -- Plugin description shown in manager (translatable) (e.g., "Provides dictionary lookup functionality")
    ...
    author = "CheetSheet",           -- Plugin creator/maintainer (e.g., "John Doe", "KOReader Team")
    license = "CheetSheet",          -- Software license (e.g., "AGPL", "MIT", "GPL-3.0")
