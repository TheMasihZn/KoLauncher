...
return {
    name = "AndroidInputBridge",                                             -- Internal plugin identifier used in code (e.g., "dictionary", "clock", "wifi")
    fullname = _("AndroidInputBridge"),                                      -- Display name shown in UI (translatable) (e.g., "Dictionary", "Clock Widget", "WiFi Manager")
    description = _([[Use any Android device in vicinity as input device]]), -- Plugin description shown in manager (translatable) (e.g., "Provides dictionary lookup functionality")
    ...
    author = "Masih",                                                      -- Plugin creator/maintainer (e.g., "John Doe", "KOReader Team")
    license = "TODO",                                                     -- Software license (e.g., "AGPL", "MIT", "GPL-3.0")
